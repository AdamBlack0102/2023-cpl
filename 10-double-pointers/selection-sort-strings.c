...
// (8) char *arr[]
//const char *arr[]: const保护的是人名！
//arr是一个数组，每个元素是一个指针，每一个指针指向了一个const char
//如果要保护指针，要写const char * const arr[]
void SelectionSort(const char *arr[], int len) {
    for (int i = 0; i < len; i++) {
        // (9)
